...
async function runBoundedCodexAppServerTurnInWorkspace(
  ...
  // Elapsed-budget math stays on a monotonic clock: a wall-clock correction
  // during async client startup is not execution time and must neither spend
  // nor extend the turn's configured bound.
